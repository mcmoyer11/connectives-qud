...
newTrial("StoryIntro1",
    ...
    ,
    newText("The child who picked the letters will give a clue.")
    ,
...
newTrial("StoryIntro2",
    defaultText.center().print()
    ,
    newText("Importantly, you will <b>press the space bar</b> to see the clue that was given.")
    ,
    newText("The sentence will be revealed in segments.")
    ,
    newText("Press the space bar to reveal each chunk of the clue.")
    ,
    newText("<p> </p>")
    ,
    newText("<b>Your job will then be to determine whether that clue is appropriate, </b>")
    ,
...
Template( "training_noQUD.csv", row =>
        newTrial("training",
            ...
            newKey(" ")
                ...
                // .log()
            ,
            newText("Answerer", `<p><b>${row.Answerer} gives the clue</b>:</p>`)
                .center()
                .print()
            ,
            newText("(Hit the space bar to continue)")
            ...
            newController("DashedSentence", {s : [`${row.AnswerConj1}`, `${row.AnswerConj2}`]})
                ...
                .wait()
            ,
            newText("Judgement", `<p>Did ${row.Answerer} give a good clue to ${row.Questioner}?</p>`)
                .center()
                .print()
            ,
